$execute unless data storage c:cv root.config.items[$(index)] run return fail

forceload add 95290 95290 95290 95290
setblock 95290 0 95290 barrel

$data modify block 95290 0 95290 Items[{Slot:0b}] set from storage c:cv root.config.items[$(index)]
