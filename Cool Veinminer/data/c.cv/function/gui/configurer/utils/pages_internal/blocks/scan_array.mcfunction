...
function c.cv:gui/configurer/utils/pages_internal/blocks/scan_slot with storage c:cv root.temp.item_handler

execute if score #iterations c.cv.dummy matches 26.. run return fail
scoreboard players add #iterations c.cv.dummy 1
function c.cv:gui/configurer/utils/pages_internal/blocks/scan_array
