$execute unless items entity @s container.$(value) * run return run function c.cv:gui/configurer/utils/pages_internal/blocks/remove_item/analize_id with storage c:cv root.temp.iterations
